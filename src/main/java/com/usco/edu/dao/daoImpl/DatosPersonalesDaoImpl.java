...
public class DatosPersonalesDaoImpl implements IDatosPersonalesDao {
	...
	public int actualizarDatosContacto(String userdb, DatosPersonales contacto) {
		...
		String sql = "UPDATE dbo.persona "
				+ "SET per_telefono_movil=:telefonoMovil, per_telefono_fijo=:telefonoFijo, per_email=:emailPersonal, per_pagina_personal=:paginaWeb "
		...
		try {
			...
			parameter.addValue("codigo", contacto.getCodigo());
	...
	public int actualizarDatosResidencia(String userdb, DatosPersonales residencia) {
		...
		String sql = "UPDATE dbo.persona "
				+ "SET per_direccion_residencia=:direccion, per_lugar_residencia=:municipio, per_departamento_residencia=:departamento, per_pais_residencia=:pais, per_barrio=:barrio "
				+ "WHERE per_codigo=:codigo;";
		...
		try {
			...
			parameter.addValue("codigo", residencia.getCodigo());
