...
public class UbicacionRestController {
	...
	@GetMapping(path = "obtener-paises/{username}")
	public List<Pais> obtenerPaises(@PathVariable String username) {
		
		return ubicacionService.obtenerPaises(username);
		
	}
	
	@GetMapping(path = "obtener-municipios/{username}")
	public List<Municipio> obtenerMunicipios(@PathVariable String username) {
		
		return ubicacionService.obtenerMunicipios(username);
		
	}
	
	@GetMapping(path = "obtener-departamentos-pais/{codigo}/{username}")
	public List<Departamento> obtenerDepartamentosPorPais(@PathVariable int codigo, @PathVariable String username) {
		
		return ubicacionService.obtenerDepartamentosPorPais(codigo, username);
		
	}
	
	@GetMapping(path = "obtener-municipios-departamento/{codigo}/{username}")
	public List<Municipio> obtenerMunicipiosPorDepartamento(@PathVariable int codigo, @PathVariable String username) {
		
		return ubicacionService.obtenerMunicipiosPorDepartamento(codigo, username);
		
	}
	
	@GetMapping(path = "obtener-departamentos-municipio/{codigo}/{username}")
	public List<Departamento> obtenerDepartamentosPorMunicipio(@PathVariable int codigo, @PathVariable String username) {
		
		return ubicacionService.obtenerDepartamentosPorMunicipio(codigo, username);
		
	}
	
	@GetMapping(path = "obtener-paises-departamento/{codigo}/{username}")
	public List<Pais> obtenerPaisesPorDepartamento(@PathVariable int codigo, @PathVariable String username) {
		
		return ubicacionService.obtenerPaisesPorDepartamento(codigo, username);
