...
public class ReporteHabilidadInformaticaRowMapper implements RowMapper<HabilidadInformatica> {
	...
	public HabilidadInformatica mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		habilidad.setPersonaNombre(rs.getString("per_nombre"));
		habilidad.setPersonaApellido(rs.getString("per_apellido"));
