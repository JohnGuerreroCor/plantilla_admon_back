...
public class ReporteRegistroEducativoRowMapper implements RowMapper<RegistroEducativo> {
	...
	public RegistroEducativo mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		registroEducativo.setPersonaNombre(rs.getString("per_nombre"));
		registroEducativo.setPersonaApellido(rs.getString("per_apellido"));
