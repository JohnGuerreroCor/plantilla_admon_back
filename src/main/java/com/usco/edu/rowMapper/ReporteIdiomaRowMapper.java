...
public class ReporteIdiomaRowMapper implements RowMapper<Idioma> {
	...
	public Idioma mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		idioma.setPersonaNombre(rs.getString("per_nombre"));
		idioma.setPersonaApellido(rs.getString("per_apellido"));
